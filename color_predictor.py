...
if __name__ == "__main__":
    ...
    training_set_inputs = numpy.array([[255/255,255/255,255/255], [0/255,0/255,0/255], [200/255,200/255,200/255], [100/255,100/255,100/255], [255/255,255/255,0/255], [0/255,255/255,255/255], [0/255,0/255,128/255]])
    training_set_outputs = numpy.array([[0,1,0,1,0,0,1]]).T
    ...
    print("New situation: [0,255,0] lime Output:")
    nn_output = neural_network.think(numpy.array([0, 255/255, 0]))
    if(nn_output > 0.5):
        print("white")
    else:
        print("black")
    print("expected: black")
